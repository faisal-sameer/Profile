     ...
     <section class="h-screen">
            <div class="container h-full px-6 py-24">
              <div
                ...
                <div class="mb-12 md:mb-0 md:w-8/12 lg:w-6/12 ml-10">
                  <img
                ...
                <div class="md:w-8/12 ml-20 lg:w-4/12  ">
                  <form method="POST" action="{{ route('login') }}">
                    @csrf
                <!-- Email input -->
                    <div class="relative mb-6" data-te-input-wrapper-init>
                      <input   name="email" value="{{ old('email') }}" required autocomplete="email" autofocus
                        type="email"
                        class="peer block min-h-[auto] w-full rounded border-0 bg-transparent @error('email') is-invalid @enderror
